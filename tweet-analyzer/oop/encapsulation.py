...
class TwitterConsoleLogin:
    def __init__(self, consumer_key, consumer_secret):
        self.consumer = consumer = oauth2.Consumer(consumer_key, consumer_secret)
...
twitter_login = TwitterConsoleLogin('hThF03txAt1fLBKvGfCODuNe6', 'uzvWbbcxxUZka0fZWN4qcjPhoT5ByPdalUPF0Mih00QF3nj3WP' )
